...
export const appName = "deferred-embedding";
...
export const backend = "https://myrtle-rattlesnake.trial.cloud.gooddata.com";
...
export const workspace = "gdc_demo_764a0125-e0e7-4710-b6e6-1c570f437796";
